...
export default function About() {
    return (
        <section className="w-[100%] mt-9 sm:mt-10 md:mt-11 flex flex-col flex-nowrap items-center justify-center gap-7 px-mobileBound sm:px-8 sm:gap-8 md:gap-9 lg:gap-10">
            <h1 className="text-center max-w-[18em]">About Viraj</h1>
            <img className="w-[300px] profile-border" src="/assets/images/Viraj.png" alt="Profile of Viraj" />
            <p className="text-justify">Hello! My name is Viraj, and I currently reside and work in NSW, Australia. My primary focus centers on constructing and enhancing websites for businesses, helping them establish a robust digital presence.</p>
            <p className="text-justify">I hold a B.S. in Computer Engineering from the University at Western Sydney. In a former role, I worked as a AI Integration engineer at LingoPal AI for 2 years. I made the transition into web development driven by my passion for designing websites and solving problems that empower businesses to thrive.</p>
            <p className="text-justify">Beyond coding and interacting with clients, I find joy in giving back to the community. In my spare time, I unleash my creativity in the kitchen by baking a wide array of scrumptious desserts, which I take pleasure in sharing with friends and fellow Toastmasters. Speaking of Toastmasters, I am an active member of the Pinnacle Toastmasters club in Pittsford, New York, where I hone my public speaking skills.</p>
